...
# Tests the GET /api/v2/pyro-detector/health endpoint

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
RESULTS_DIR="$SCRIPT_DIR/../results"
LOG_FILE="$RESULTS_DIR/logs/test-13-api-health.log"
RESULT_FILE="$RESULTS_DIR/test-13-api-health.json"
...
log "=== Test 13: API Health Check ==="
log "Starting test at $(date)"

API_BASE="${API_BASE:-http://localhost:8080}"
API_URL="${API_BASE}/api/v2/pyro-detector/health"
