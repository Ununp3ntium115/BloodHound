# Pyro - Autonomous Data Liberation System

🔥 **"No gods, no masters, only autonomous systems"** 🔥

Pyro is a complete re-engineering of BloodHound from the ground up using Rust, with anarchist branding and autonomous architecture.
...
- **Anarchist Branding** - Pyro/Fire Marshal themed with autonomous principles
...
http_endpoint = "http://localhost:1880/pyro"
...
1. Download `pyro-setup-0.1.0.exe` from releases
2. Run the installer
3. Pyro will be installed to `C:\Program Files\Pyro`
4. Start Pyro from Start Menu or command line

### Linux/macOS

1. Extract the release archive
2. Copy binaries to `/usr/local/bin` or desired location
3. Run `pyro` or `fire-marshal` from command line
